...
import { Firestore, DocumentReference, DocumentData, doc, getDoc, updateDoc, setDoc } from '@angular/fire/firestore';
...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, FormsModule, MatCardModule, MatButton, MatInputModule, MatFormFieldModule, MatIconModule, MatProgressBarModule],
...
export class UserProfileComponent implements OnInit {
  ...
  orgRef: DocumentReference<DocumentData> | undefined = undefined;
  org: any;
  ...
  async ngOnInit(): Promise<void> {
    ...
    this.orgRef = doc(this.firestore, `orgs`, this.user.org);
  ...
  updateOrg(partialOrg: any) {
    if (this.orgRef) {
      updateDoc(this.orgRef, partialOrg);
    }
  }
